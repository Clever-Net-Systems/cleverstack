# Taken from https://raw.githubusercontent.com/stackforge/puppet-cinder/master/manifests/setup_test_volume.pp
# Until that version is automatically downloaded with puppet module install
...
class cleverstack::setup_test_volume(
